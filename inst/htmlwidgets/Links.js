...
Links = (function() {
  ...
  Links.prototype.getLinkData = function() {
    return this.links;
  };

  Links.prototype.getNewPtOnLogoLabelBorder = function(label, anchor, anchor_array) {
  ...
  Links.prototype.getNewPtOnTxtLabelBorder = function(label, anchor, anchor_array) {
  ...
  Links.prototype.getPtOnAncBorder = function(cx, cy, cr, x, y) {
