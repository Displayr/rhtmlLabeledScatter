...
LabeledScatter = (function() {
  ...
  LabeledScatter.prototype.draw = function(data, el) {
    ...
    this.plot = new RectPlot(this.width, this.height, this.data.X, this.data.Y, this.data.group, this.data.label, svg, this.data.fixedAspectRatio, this.data.xTitle, this.data.yTitle, this.data.colors, this.data.grid, this.data.origin, this.data.title, this.data.titleFontFamily, this.data.yTitleFontFamily, this.data.xTitleFontFamily, this.data.labelsFontFamily, this.data.labelsFontSize, this.data.labelsFontColor, this.data.xDecimals, this.data.yDecimals, this.data.xPrefix, this.data.yPrefix);
    this.plot.draw();
    return this;
  };
